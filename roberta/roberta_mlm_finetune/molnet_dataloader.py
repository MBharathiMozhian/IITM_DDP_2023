...
import pandas as pd
from deepchem.molnet import load_bbbp, load_clearance, load_clintox, load_delaney, load_hiv, load_qm7, load_tox21, load_bace_classification, load_bace_regression
...
def load_molnet_dataset(
    ...
    #     tasks_wanted,
    #     [
    #         s.to_dataframe() for s in splits
    #     ],
    #     transformers,
    # )
...
def make_dataframe(
    ...
    # Canonicalize SMILES
    # smiles_list = [Chem.MolToSmiles(s, isomerification=True) for s in df["X"]]
